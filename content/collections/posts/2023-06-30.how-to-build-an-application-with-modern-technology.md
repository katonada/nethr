...
bard_field:
  -
    ...
    content:
      -
        type: text
        text: 'Sektor obnovljive energije doživio je izvanredne napretke tijekom proteklog desetljeća. S obzirom na klimatske promjene i potrebu za održivim izvorima energije, obnovljivi izvori poput sunca, vjetra i hidroenergije postaju sve važniji.'
  -
    type: paragraph
    content:
      -
        type: text
        text: '### Zašto je važno ulagati u obnovljivu energiju'
  -
    type: paragraph
    content:
      -
        type: text
        text: 'Obnovljiva energija smanjuje ovisnost o fosilnim gorivima i pomaže u smanjenju emisije štetnih plinova. Tehnološki napredak omogućuje veću dostupnost i učinkovitost obnovljivih izvora energije, što pridonosi globalnim naporima za održivost.'
  -
    type: paragraph
    content:
      -
        type: text
        text: '### Pogled u budućnost'
  -
    type: paragraph
    content:
      -
        type: text
        text: 'Kako bi se nastavilo s ovim napretkom, bit će ključno nastaviti s istraživanjem i razvojem novih tehnologija te osigurati podršku vlada i industrija.'
  -
    type: paragraph
content:
  -
